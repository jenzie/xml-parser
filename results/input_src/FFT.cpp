...
static void FFT_transform_internal (int N, double *data, int direction, int print) {
    int n = N/2;
    int bit = 0;
    int logn;
    int dual = 1;
...
// MODIFIED FOR TEST CODE
void FFT_transform(int N, double *data, int print)
{
  FFT_transform_internal(N, data, -1, print);
}


void FFT_inverse(int N, double *data, int print)
{
    int n = N/2;
    double norm = 0.0;
    int i=0;
